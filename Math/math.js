...
const mojeČíslo3 = Math.pow(10, 12) // Pow metóda = v tomto prípade dva na tretiu
const mojeČíslo4 = Math.sqrt(64) // SQRT metóda odmocnina
const mojeČíslo5 = Math.abs(-7) // Absolútna hodnota daného čísla
 
console.log(mojeČíslo3)

const výplaty = [530, 700, 650, 900, 1150, 950, 1000, 1080, 720, 530, 295, 95]
